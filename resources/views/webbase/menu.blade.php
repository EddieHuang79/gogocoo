...
<section class="sidebar">
	...
	<ul class="sidebar-menu">
		...
		<li class="treeview">
			@if(!empty($row['child']))
			<a href="#"><i class="fa fa-list"></i> <span>{{ $row['name'] }}</span> <i class="fa fa-angle-left pull-right"></i></a>
			...
			@else
			<a href="{{ $row['link'] }}?service_id={{ $row['id'] }}" page="page{{ $row['id'] }}"><i class="fa fa-list"></i> <span>{{ $row['name'] }}</span> <i class="fa fa-angle-left pull-right"></i></a>
			@endif
		</li>				
		@endforeach
